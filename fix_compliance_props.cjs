...
export default function Compliance() {
  ...
  return (
    <div className="p-8 text-[var(--text-main)] animate-fade-in relative h-full flex flex-col overflow-hidden">
      ...
      {showReportModal && <ReportModal onClose={() => setShowReportModal(false)} stats={stats} locationStats={locationStats} />}
...
// Execution
console.log("🚀 Fixing Props in Compliance Index...");
...
console.log("\n✅ Done. TypeScript error resolved.");